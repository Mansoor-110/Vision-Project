...
$query="select * from add_product where product_id='$product_id' and seller_id='$seller_id'";
...
<div class="main-content">
    ...
    <div class="form-container">
        <form id="addProductForm" action="../admin/update_product_crud.php" method="POST" enctype="multipart/form-data">
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="hidden" name="product_id" class="form-input" Value=<?php echo $product_id;?> required>
                    <input type="text" name="product_name" class="form-input" Value=<?php echo $data['product_name'];?> required>
                ...
                <div class="form-group">
                    ...
                    <select name="product_category" id="category" class="form-select" onchange="updateSubcategories()" required>
                        ...
                        <option value="Jewellery"<?php if($data['product_category']=="Jewellery"){echo "selected";}?>>Jewellery</option>
                        <option value="Cosmetics"<?php if($data['product_category']=="Cosmetics"){echo "selected";}?>>Cosmetics</option>
                        <option value="Beauty Tools"<?php if($data['product_category']=="Beauty Tools"){echo "selected";}?>>Beauty Tools</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="product_subcategory" id="subcategory" class="form-select" required>
                        <option value=<?php echo $data['product_subcategory'];?>><?php echo $data['product_subcategory'];?></option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="price-input-group">
                        ...
                        <input type="number" name="product_price" class="form-input price-input" Value=<?php echo $data['product_price'];?> step="0.01" min="0" required>
                    </div>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea name="product_description" class="form-textarea"   required><?php echo $data['product_description'];?></textarea>
                ...
                <div class="form-group full-width">
                    ...
                    <div class="form-hint">Upload high-quality image of your product Or Continue with Previous one</div>
                    <input type="hidden" name="product_url" value="<?php echo $data['product_image'];?>">
                </div>
