              ...
              <div class="card-body px-5 py-5">
                ...
                <form action="admin_register.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control p_input" name="user_image">
                  </div>
                  <div class="form-group">
                    <label>Email</label>
                    <input type="email" class="form-control p_input" name="user_email">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control p_input" name="r_password">
                  </div>
                  ...
                  <div class="text-center">
                    <input type="submit" class="btn btn-primary btn-block enter-btn" name="submit">
                  </div>
